...
def runs_images_download(id: str, img_count: int, download_img_spacex: bool, download_img_apod: bool, download_img_epic: bool) -> None:
    '''
...
def main():
    ...
    runs_images_download(args.ID, args.IMG_Count, args.SpaceX, args.APOD, args.EPIC)
